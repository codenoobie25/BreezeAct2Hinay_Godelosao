    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col items-center">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mx-auto w-full max-w-2xl">
                ...
                <form method="POST" action="{{ route('products.store') }}" class="mt-2 flex flex-col items-center">
                    @csrf
                    ...
                    <div class="mb-4 w-full max-w-sm">
                        ...
                        <input type="text" name="product_name" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 text-left">
                            {{ __('Product Price') }}
                        </label>
                        <input type="text" name="price" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 text-left">
                            {{ __('Status') }}
                        </label>
